#Source:
#https://github.com/TalkingQuickly/capistrano-3-rails-template/blob/10e01237294714d1297d0394169d566ebee4cd21/lib/capistrano/template.rb
...
def template_file(name)
  if File.exist?((file = "lib/capistrano/templates/#{fetch(:application)}/#{name}.erb"))
    return file
  elsif File.exist?((file = "lib/capistrano/templates/#{name}.erb"))
    return file
  end
  return nil
end
